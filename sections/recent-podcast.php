<?php
  ...
  if(!isset($_SESSION['SuperFM963'])){
    header('location:login?ref=recent-podcast');
  }
  else{
...
<head>
    ...
    <title>Recent Podcast | SUper 96.3 FM</title>
  ...
  <div class="modal-dialog" role="document" style=" z-index: 10000;">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title">Add a Podcast from Soundcloud </h3>
          ...
          <div class="form-bg" style="width: 100%;">
            ...
            <form id="fpost" class="form-horizontal" style="padding-bottom: 0px; overflow-x: hidden;">
              ...
              <div class="form-group help" style="">
                  <input type="hidden" name="type" value="addRPodcast" />
                 
                  <label for=""><strong>Title</strong></label>
                  <input name="title" id="title" class="form-control tt"/>

                  <label for=""><strong>Soundcloud link</strong></label>
                  <input name="link" id="link" class="form-control tt"/>

                  <label for=""><strong>About podcast</strong></label>
                  <textarea name="details" placeholder="Details" class="form-control tt" style="min-height: 90px;"></textarea>
                        ...
                        <div class="">
                            <form id="editform" class="form-horizontal" style="">
                                ...
                                <div class="form-group help" style="">
                                     ...
                                     <input type="hidden" name="type" value="editRPodcast">
                                    ...
                                    <label for=""><strong>About podcast</strong></label>
                                    <textarea name="details" id="detailsE" placeholder="Enter details" class="form-control ttE" style="min-height: 90px;"></textarea>
              ...
              <br />
                ...
                <div class="">
                    ...
                    <div class="">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">Podcast from Soundcloud <button data-toggle="modal" data-target="#modal-1" class="btn btn-primary btn-xs addn" style="margin-left: 10px;">Add new</button></h4>
...
<script src="https://gitcdn.github.io/bootstrap-toggle/2.2.2/js/bootstrap-toggle.min.js"></script>
    ...
    <script type="text/javascript">
      $(document).ready(function() {
       ...
       $('#selart').on('change', function(){
        ...
        $.getJSON('j_recent_podcast.php', function(data) {
          $('.MClist').html('');
          ...
          $('.clm').each(function(){
           ...
           $('.delete').click(function(event) {
            ...
            $('.toggle1').change(function(){
              var uid = $(this).attr('data-uid');
              if(this.checked){
                Ajx_live(uid,"on","recentpodcast");
                //$.toaster({ message : "Enabled",priority : 'info'});
              }
              else{
                Ajx_live(uid,"off","recentpodcast");
    ...
    function GetOne(uid){
        ...
        $.getJSON('j_recent_podcast.php',{uid:uid}, function(data) {
          $('.MCEdit').html('');
          //alert(data.Feed.length);
          $.each(data.Feed, function(i,result){
