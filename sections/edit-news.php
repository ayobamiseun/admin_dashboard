<?php
    ...
    if(!isset($_SESSION['SuperFM963'])){
      ...
      if($num < 1){
        ...
        $sqle = mysqli_query($con,"select * from news where uid = '$_REQUEST[uid]'");
                                                ...
                                                <div class="">
                                                    <form id="fpost" class="form-horizontal" style="padding-bottom: 0px; overflow-x: hidden;">
                                                        ...
                                                        <div class="form-group help" style="">
                                                            <input type="hidden" name="type" value="editNews" />
      ...
      $(document).ready(function() {
       ...
       $('#selart').on('change', function(){
        ...
        function GetOne(uid){
          ...
          $.getJSON('j_news.php',{uid:uid, tt:"uid"}, function(data) {
            $('.MCEdit').html('');
            ...
            $.each(data.Feed, function(i,result){
              ...
              UpdateFireNews(uid,odr,title,image,details,link,type,status,date);
        ...
        function UpdateFireNews(uid,odr,title,image,details,link,type,status,date){
          
          db.collection("NewsUpdate").doc(uid).update({
