<?php
    ...
    if(!isset($_SESSION['SuperFM963'])){
      ...
      if($num < 1){
        ...
        $sqle = mysqli_query($con,"select * from podcasts where uid = '$_REQUEST[uid]'");
...
<head>
    ...
    <title>Podcast | <?php echo $title; ?> | Super 96.3 FM</title>
                                                ...
                                                <div class="">
                                                    <form id="fpost" class="form-horizontal" style="padding-bottom: 0px; overflow-x: hidden;">
                                                        ...
                                                        <div class="form-group help" style="">
                                                            <input type="hidden" name="type" value="editPodcast" />
                                                            ...
                                                            <label>Guest :  </label>
                                                            <input type="text" id="artist" name="guest" value="<?php echo $guest ?>" class="form-control tt">
