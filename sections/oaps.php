                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title">Delete this oap</h4>
                                    </div>
                                    <div class="modal-body">
                            
                                       <p>Are you sure you want to delete this oap ?</p>
              ...
              <br />
                ...
                <div class="">
                    ...
                    <div class="">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">OAPs <span></span>   <button data-toggle="modal" data-target="#modal-11" class="btn btn-primary btn-xs addn" style="margin-left: 10px;">Add new</button></h4>
                                                ...
                                                <div class="">
                                                    <form id="fpost" class="form-horizontal" style="padding-bottom: 0px; overflow-x: hidden;">
                                                        ...
                                                        <div class="form-group help" style="">
                                                            <input type="hidden" name="type" value="addOAP" />
                                                            ...
                                                            <label for=""><strong>OAP full name</strong></label>
                                                            <input name="name" class="form-control tt"/>

                                                            <label for=""><strong>OAP nick name</strong></label>
                                                            <input name="nick" class="form-control tt"/>

                                                            <label for=""><strong>Show title</strong></label>
                                                            <input name="show" class="form-control tt"/>
                                                            ...
                                                            <label for=""><strong>About OAP</strong></label>
                                                             <div id="editor" style="">
    ...
    <script type="text/javascript">
      $(document).ready(function() {
       ...
       $('#selart').on('change', function(){
           ...
           var formData = new FormData($('#fpost')[0]);
            ...
            .done(function(data) {
                ...
                if(data == 'success'){
                    ...
                    $('.send-report').text('Error creating');
                }
        ...
        $.getJSON('j_oaps.php',function(data) {
          $('.MClist').html('');
          ...
          $.each(data.Feed, function(i,result){
            ...
            var newRow =               
                                         ...
                                         '<tr class="clm" data-status="'+result.status+'" >'
                                          ...
                                          +'<td><div class="'+result.uid+' btn btn-primary btn-xs edit1">'+result.odr+'</div></td>'
                                          +'<td><img src="'+result.picture+'" style="width:50px;"/></td>'
                                          +'<td>'+result.name+'</td>'
                                          +'<td><button class="btn btn-info btn-xs">'+result.nick+'</button></td>'
                                          +'<td>'
                                              +'<a href="edit-oap.php?uid='+result.uid+'" class="btn btn-primary btn-xs edit1" data-uid="'+result.uid+'" style="margin:0px 5px;">Edit</a>'
