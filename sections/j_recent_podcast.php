<?php 
	...
	if(empty($_REQUEST['uid'])){
		...
		$sql = mysqli_query($con, "select * from recent_podcast order by id desc");
	}
	else{
		$sql = mysqli_query($con, "select * from recent_podcast where uid = '$_REQUEST[uid]'");
	}
