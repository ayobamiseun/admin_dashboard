              ...
              <br />
                ...
                <div class="">
                    ...
                    <div class="">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">Blog Posts <span></span>   <button data-toggle="modal" data-target="#modal-11" class="btn btn-primary btn-xs addn" style="margin-left: 10px;">Add new</button></h4>
                                                ...
                                                <div class="">
                                                    <form id="fpost" class="form-horizontal" style="padding-bottom: 0px; overflow-x: hidden;">
                                                        ...
                                                        <div class="form-group help" style="">
                                                            ...
                                                            <input type="hidden" name="blogger" value="<?php echo $name; ?>">
...
<script src="https://gitcdn.github.io/bootstrap-toggle/2.2.2/js/bootstrap-toggle.min.js"></script>
  ...
  firebase.initializeApp(firebaseConfig);
    ...
    <script type="text/javascript">
      $(document).ready(function() {
       ...
       $('#selart').on('change', function(){
        ...
        $.getJSON('j_posts.php',{username:username, privilage:privilage}, function(data) {
          $('.MClist').html('');
          ...
          $.each(data.Feed, function(i,result){
            ...
            var newRow =               
                                         ...
                                         '<tr class="clm" data-status="'+result.status+'" >'
                                          ...
                                          +'<td>'+result.title+'<p><a target="_blank" href="https://superfm963.com/blog-post?id='+result.title_uid+'">https://superfm963.com/blog-post?id='+result.title_uid+'</a></p></td>'
                                          ...
                                          +'</td>'
                                          +'<td>'
                                              +'<a href="edit-post.php?uid='+result.uid+'" class="btn btn-primary btn-xs edit1" data-uid="'+result.uid+'" style="margin:0px 5px;">Edit</a>'
          ...
          $('.clm').each(function(){
           ...
           $('.delete').click(function(event) {
            ...
            $('.toggle1').change(function(){
              var uid = $(this).attr('data-uid');
              if(this.checked){
                Ajx_live(uid,"on","post");
                //$.toaster({ message : "Enabled",priority : 'info'});
              }
              else{
                Ajx_live(uid,"off","post");
    ...
    function GetOne(uid){
        ...
        $.getJSON('j_posts.php',{uid:uid, tt:"title"}, function(data) {
          ...
          $.each(data.Feed, function(i,result){
            ...
            PostFireBlog(uid,odr,title,image,details,link,type,status,date);
    ...
    function PostFireBlog(uid,odr,title,image,details,link,type,status,date){

       // store.set("blog_name",name);
      //store.set("blog_email",email);
        
        db.collection("Blog").doc(uid).set({
