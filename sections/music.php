...
<head>
    ...
    <title>Music| Suoer 96.3 FM</title>
              ...
              <br />
                ...
                <div class="">
                    ...
                    <div class="">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">Music <span></span>   <button data-toggle="modal" data-target="#modal-11" class="btn btn-primary btn-xs addn" style="margin-left: 10px;">Add new</button></h4>
                                                    ...
                                                    <form id="fpost" class="form-horizontal" style="padding-bottom: 0px; overflow-x: hidden;">
                                                        ...
                                                        <div class="form-group help" style="">
                                                          ...
                                                          <select name="download" class="form-control tt">
                                                            ...
                                                            <label for=""><strong>About music / artist</strong></label>
                                                             <div id="editor" style="">
    ...
    <script type="text/javascript">
      $(document).ready(function() {
       ...
       $('#selart').on('change', function(){
        ...
        $.getJSON('j_music.php', function(data) {
          $('.MClist').html('');
          ...
          $.each(data.Feed, function(i,result){
            ...
            var newRow =               
                                         ...
                                         '<tr class="clm" data-status="'+result.status+'" >'
                                          ...
                                          +'<td>'+result.title+'<p><a target="_blank" href="https://superfm963.com/song?id='+result.uid+'">https://superfm963.com/song?id='+result.uid+'</a></p></td>'
                                          +'<td><button class="btn btn-info btn-xs">'+result.genres+'</button></td>'
                                          ...
                                          +'<td>'+result.date+'</td>'
                                          +'<td>'
                                              +'<a href="edit-music.php?uid='+result.uid+'" class="btn btn-primary btn-xs edit1" data-uid="'+result.uid+'" style="margin:0px 5px;">Edit</a>'
