      ...
      <div class="modal-body">
          <div class="form-bg" style="width: 100%;">
              ...
              <div class="form-group help" style="">
                  <input type="hidden" name="type" value="addAdvert" />
                        ...
                        <div class="">
                            <form id="editform" class="form-horizontal" style="">
                                ...
                                <div class="form-group help" style="">
                                     ...
                                     <input type="hidden" name="type" value="editAdvert">
              ...
              <br />
                ...
                <div class="">
                    ...
                    <div class="">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">Advert <button data-toggle="modal" data-target="#modal-1" class="btn btn-primary btn-xs addn" style="margin-left: 10px;">Add new</button></h4>
...
<script src="https://gitcdn.github.io/bootstrap-toggle/2.2.2/js/bootstrap-toggle.min.js"></script>
    ...
    <script type="text/javascript">
      $(document).ready(function() {
       ...
       $('#selart').on('change', function(){
        ...
        $.getJSON('j_adverts.php', function(data) {
          $('.MClist').html('');
          ...
          $('.clm').each(function(){
           ...
           $('.delete').click(function(event) {
            ...
            $('.toggle1').change(function(){
              var uid = $(this).attr('data-uid');
              if(this.checked){
                Ajx_live(uid,"on","advert");
                //$.toaster({ message : "Enabled",priority : 'info'});
              }
              else{
                Ajx_live(uid,"off","advert");
    ...
    function GetOne(uid){
        ...
        $.getJSON('j_adverts.php',{uid:uid}, function(data) {
          $('.MCEdit').html('');
          //alert(data.Feed.length);
          $.each(data.Feed, function(i,result){
