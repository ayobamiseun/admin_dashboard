<?php
  ...
  if(!isset($_SESSION['SuperFM963'])){
    header('location:login?ref=news-update');
  }
  else{
...
<head>
    ...
    <title>News Update | Super FM 96.3</title>
          ...
          <div class="form-bg" style="width: 100%;">
              ...
              <div class="form-group help" style="">
                  <input type="file" class="selart" id="selart" style="display:none;">
                           ...
                           <input type="hidden" name="type" value="addNewsUpdate">
                           

                            <br />

                          <label>News :  </label>
                          <textarea class="form-control tt ntitle" name="details" placeholder="Write news here"></textarea>
                        ...
                        <div class="">
                            <form id="editform" class="form-horizontal" style="">
                                ...
                                <div class="form-group help" style="">
                                     ...
                                     <input type="hidden" name="type" value="editNewsUpdate">
                                   ...
                                   <label>News :  </label>
                                  <textarea class="form-control newsE ttE" name="details" placeholder="Write news here"></textarea>
              ...
              <br />
                ...
                <div class="">
                    ...
                    <div class="">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">News Update <button data-toggle="modal" data-target="#modal-1" class="btn btn-primary btn-xs addn" style="margin-left: 10px;">Add new</button></h4>
  ...
  var db = firebase.firestore();
    ...
    <script type="text/javascript">
      $(document).ready(function() {
        ...
        $.getJSON('j_news_update.php', function(data) {
          $('.MClist').html('');
          //alert(data.Feed.length);
          $.each(data.Feed, function(i,result){

            //UpdateFireNews(result.uid,result.odr,result.details,result.date);
    ...
    function FetchData(ut){
          ...
          $.getJSON('j_get_news_update.php',{tt:ut}, function(data) {
            $('.MCEdit').html('');
            //alert(data.Feed.length);
            $.each(data.Feed, function(i,result){
              ...
              UpdateFireNews(uid,odr,details,date);
    ...
    function UpdateFireNews(uid,odr,details,date){

          db.collection("NewsUpdate").doc(uid).set({
    ...
    function Ajax_delete(){
        ...
        .done(function(data) {
            ...
            if(data == "success"){
                ...
                $('.close1').click();
                db.collection("NewsUpdate").doc(uid).delete();
            }
            else if(data == "error"){
    ...
    function GetOne(uid){
        ...
        $('.MCEdit').html('<span class="fa fa-spin fa-spinner fa-3x" style="color:blue;"></span>');
        $.getJSON('j_news_update.php',{uid:uid}, function(data) {
          $('.MCEdit').html('');
          //alert(data.Feed.length);
          $.each(data.Feed, function(i,result){
            
            $('#uidE').val(result.uid);
            $('.newsE').val(result.details);
