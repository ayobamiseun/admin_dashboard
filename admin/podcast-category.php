<?php
  ...
  if(!isset($_SESSION['SuperFM963'])){
    header('location:login?ref=podcast-category');
  }
  else{
...
<head>
    ...
    <title>Podcast Category | Suoer 96.3 FM</title>
          ...
          <div class="form-bg" style="width: 100%;">
            ...
            <form id="fpost" class="form-horizontal" style="padding-bottom: 0px; overflow-x: hidden;">
              ...
              <div class="form-group help" style="">
                  <input type="hidden" name="type" value="addPodcastCat" />
                        ...
                        <div class="">
                            <form id="editform" class="form-horizontal" style="">
                                ...
                                <div class="form-group help" style="">
                                     ...
                                     <input type="hidden" name="type" value="editPodcastCat">
              ...
              <br />
                ...
                <div class="">
                    ...
                    <div class="">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">Podcast Category <button data-toggle="modal" data-target="#modal-1" class="btn btn-primary btn-xs addn" style="margin-left: 10px;">Add new</button></h4>
...
<script src="https://gitcdn.github.io/bootstrap-toggle/2.2.2/js/bootstrap-toggle.min.js"></script>
    ...
    <script type="text/javascript">
      $(document).ready(function() {
       ...
       $('#selart').on('change', function(){
        ...
        $.getJSON('j_podcast_cat.php', function(data) {
          $('.MClist').html('');
    ...
    function GetOne(uid){
        ...
        $.getJSON('j_podcast_cat.php',{uid:uid}, function(data) {
          $('.MCEdit').html('');
          //alert(data.Feed.length);
          $.each(data.Feed, function(i,result){
