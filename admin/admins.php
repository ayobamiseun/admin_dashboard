<?php
  ...
  if(!isset($_SESSION['SuperFM963'])){
    header('location:login?ref=admins');
  }
  else{
...
<head>
    ...
    <title>Admins | Super FM 96.3</title>
  ...
  <div class="modal-dialog" role="document" style=" z-index: 10000;">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title">Add a admin </h3>
          ...
          <div class="form-bg" style="width: 100%;">
            ...
            <form id="fpost" class="form-horizontal" style="padding-bottom: 0px; overflow-x: hidden;">
              ...
              <div class="form-group help" style="">
                  ...
                  <input name="username" class="form-control tt"/>
                        ...
                        <div class="">
                            <form id="editform" class="form-horizontal" style="">
                                ...
                                <div class="form-group help" style="">
                                    ...
                                    <label for=""><strong>Username</strong></label>
                                    <input name="username" id="usernameE" class="form-control ttE"/>

                                    <label for=""><strong>Password</strong></label>
                                    <input name="password" id="passwordE" class="form-control ttE"/>
              ...
              <br />
                ...
                <div class="">
                    ...
                    <div class="">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">Admins <button data-toggle="modal" data-target="#modal-1" class="btn btn-primary btn-xs addn" style="margin-left: 10px;">Add new</button></h4>
...
<script src="https://gitcdn.github.io/bootstrap-toggle/2.2.2/js/bootstrap-toggle.min.js"></script>
    ...
    function GetOne(uid){
        ...
        $.getJSON('j_admins.php',{uid:uid}, function(data) {
          $('.MCEdit').html('');
          //alert(data.Feed.length);
          $.each(data.Feed, function(i,result){
            ...
            $('#usernameE').val(result.username);
            $('#passwordE').val(result.password);
