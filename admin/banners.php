<?php
  ...
  if(!isset($_SESSION['GoLiveBlogUser'])){
    //header('location:login?ref=adverts');
  }
  else{
...
<head>
    ...
    <title>Web Banners | Super FM 96.3</title>
              ...
              <div class="form-group help" style="">
                  <input type="file" class="selart" id="selart" style="display:none;">
                           ...
                           <input type="hidden" name="type" value="addBanner">
                            <input type="hidden" name="uuid" value="<?php echo $vv; ?>">

                            <br />

                          <label>Title :  </label>
                          <input type="text" id="name" name="name" class="form-control tt">
                          ...
                          <div class="row">
                            <div class="col-md-6"><div class="btn btn-info btn-xs clkart" id="">Select banner</div></div>
                            <div class="col-md-6">
                        ...
                        <div class="">
                            <form id="editform" class="form-horizontal" style="">
                                ...
                                <div class="form-group help" style="">
                                    ...
                                    <div class="row">
                                      <div class="col-md-6"><div class="btn btn-info btn-xs clkart1" id="">Change banner</div></div>
                                      <div class="col-md-6">
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title">Delete this banner</h4>
                                    </div>
                                    <div class="modal-body">
              ...
              <br />
                ...
                <div class="">
                    ...
                    <div class="">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">Web banners <button data-toggle="modal" data-target="#modal-1" class="btn btn-primary btn-xs addn" style="margin-left: 10px;">Add new</button></h4>
...
<script src="https://gitcdn.github.io/bootstrap-toggle/2.2.2/js/bootstrap-toggle.min.js"></script>
    ...
    <script type="text/javascript">
      $(document).ready(function() {
        ...
        $.getJSON('j_banners.php', function(data) {
          $('.MClist').html('');
          ...
          $.each(data.Feed, function(i,result){
            ...
            var newRow =               
                                         ...
                                         '<tr class="clm" data-status="'+result.status+'">'
                                          +'<td>'+result.sn+'</td>'
                                          +'<td><img src="'+result.art+'" style="height:50px;"/></td>'
                                          +'<td>'+result.title+'</td>'
                                          +'<td><div class="btn btn-info btn-xs edit1" data-uid="'+result.uid+'">'+result.odr+'</div></td>'
                                          +'<td>'+result.link+'</td>'
                                          +'<td>'
                                            +'<label class="checkbox-inline" style="color:#fff !important;">'
                                              +'<input class="toggle1" style="color:#fff !important;" data-uid="'+result.uid+'" type="checkbox" data-toggle="toggle" data-on="Enabled" data-off="Disabled">'
                                            +'</label>'
                                          +'</td>'
                                          +'<td>'+result.date+'</td>'
                                          +'<td>'
          ...
          $('.clm').each(function(){
           ...
           $('.delete').click(function(event) {
            ...
            $('.toggle1').change(function(){
              var uid = $(this).attr('data-uid');
              if(this.checked){
                Ajx_live(uid,"on","banner");
                //$.toaster({ message : "Enabled",priority : 'info'});
              }
              else{
                Ajx_live(uid,"off","banner");
    ...
    function GetOne(uid){
        ...
        $.getJSON('j_banners.php',{uid:uid}, function(data) {
          $('.MCEdit').html('');
          //alert(data.Feed.length);
          $.each(data.Feed, function(i,result){
